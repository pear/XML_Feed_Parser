...
class cdf_TestCase extends PHPUnit_TestCase {

	function test_channel_abstract_map_description_1 () { 
		$content = file_get_contents('../feedparsertests/wellformed/cdf/channel_abstract_map_description.xml');
		try {
	...
	function test_channel_abstract_map_tagline_1 () { 
		$content = file_get_contents('../feedparsertests/wellformed/cdf/channel_abstract_map_tagline.xml');
		try {
			$feed = new XML_Feed_Parser($content);
		} catch (XML_Feed_Parser_Exception $e) {
			$this->assertTrue(false);
	...
	function test_channel_href_map_link_1 () { 
		$content = file_get_contents('../feedparsertests/wellformed/cdf/channel_href_map_link.xml');
		try {
			$feed = new XML_Feed_Parser($content);
		} catch (XML_Feed_Parser_Exception $e) {
			$this->assertTrue(false);
	...
	function test_channel_href_map_links_1 () { 
		$content = file_get_contents('../feedparsertests/wellformed/cdf/channel_href_map_links.xml');
		try {
			$feed = new XML_Feed_Parser($content);
		} catch (XML_Feed_Parser_Exception $e) {
			$this->assertTrue(false);
	...
	function test_channel_title_1 () { 
		$content = file_get_contents('../feedparsertests/wellformed/cdf/channel_title.xml');
		try {
			$feed = new XML_Feed_Parser($content);
		} catch (XML_Feed_Parser_Exception $e) {
			$this->assertTrue(false);
	...
	function test_item_abstract_map_description_1 () { 
		$content = file_get_contents('../feedparsertests/wellformed/cdf/item_abstract_map_description.xml');
		try {
			$feed = new XML_Feed_Parser($content);
		} catch (XML_Feed_Parser_Exception $e) {
			$this->assertTrue(false);
	...
	function test_item_abstract_map_summary_1 () { 
		$content = file_get_contents('../feedparsertests/wellformed/cdf/item_abstract_map_summary.xml');
		try {
			$feed = new XML_Feed_Parser($content);
		} catch (XML_Feed_Parser_Exception $e) {
			$this->assertTrue(false);
	...
	function test_item_href_map_link_1 () { 
		$content = file_get_contents('../feedparsertests/wellformed/cdf/item_href_map_link.xml');
		try {
			$feed = new XML_Feed_Parser($content);
		} catch (XML_Feed_Parser_Exception $e) {
			$this->assertTrue(false);
	...
	function test_item_href_map_links_1 () { 
		$content = file_get_contents('../feedparsertests/wellformed/cdf/item_href_map_links.xml');
		try {
			$feed = new XML_Feed_Parser($content);
		} catch (XML_Feed_Parser_Exception $e) {
			$this->assertTrue(false);
	...
	function test_item_title_1 () { 
		$content = file_get_contents('../feedparsertests/wellformed/cdf/item_title.xml');
		try {
			$feed = new XML_Feed_Parser($content);
		} catch (XML_Feed_Parser_Exception $e) {
			$this->assertTrue(false);
