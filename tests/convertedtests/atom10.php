...
class atom10_TestCase extends PHPUnit_TestCase {

	function test_atom10_namespace_1 () { 
		$content = file_get_contents('../feedparsertests/wellformed/atom10/atom10_namespace.xml');
		try {
	...
	function test_atom10_version_1 () { 
		$content = file_get_contents('../feedparsertests/wellformed/atom10/atom10_version.xml');
		try {
			$feed = new XML_Feed_Parser($content);
		} catch (XML_Feed_Parser_Exception $e) {
			$this->assertTrue(false);
	...
	function test_entry_author_email_1 () { 
		$content = file_get_contents('../feedparsertests/wellformed/atom10/entry_author_email.xml');
		try {
			$feed = new XML_Feed_Parser($content);
		} catch (XML_Feed_Parser_Exception $e) {
			$this->assertTrue(false);
	...
	function test_entry_author_map_author_1 () { 
		$content = file_get_contents('../feedparsertests/wellformed/atom10/entry_author_map_author.xml');
		try {
			$feed = new XML_Feed_Parser($content);
		} catch (XML_Feed_Parser_Exception $e) {
			$this->assertTrue(false);
	...
	function test_entry_author_map_author_2_1 () { 
		$content = file_get_contents('../feedparsertests/wellformed/atom10/entry_author_map_author_2.xml');
		try {
			$feed = new XML_Feed_Parser($content);
		} catch (XML_Feed_Parser_Exception $e) {
			$this->assertTrue(false);
	...
	function test_entry_author_name_1 () { 
		$content = file_get_contents('../feedparsertests/wellformed/atom10/entry_author_name.xml');
		try {
			$feed = new XML_Feed_Parser($content);
		} catch (XML_Feed_Parser_Exception $e) {
			$this->assertTrue(false);
	...
	function test_entry_author_uri_1 () { 
		$content = file_get_contents('../feedparsertests/wellformed/atom10/entry_author_uri.xml');
		try {
			$feed = new XML_Feed_Parser($content);
		} catch (XML_Feed_Parser_Exception $e) {
			$this->assertTrue(false);
	...
	function test_entry_author_url_1 () { 
		$content = file_get_contents('../feedparsertests/wellformed/atom10/entry_author_url.xml');
		try {
			$feed = new XML_Feed_Parser($content);
		} catch (XML_Feed_Parser_Exception $e) {
			$this->assertTrue(false);
	...
	function test_entry_category_label_1 () { 
		$content = file_get_contents('../feedparsertests/wellformed/atom10/entry_category_label.xml');
		try {
			$feed = new XML_Feed_Parser($content);
		} catch (XML_Feed_Parser_Exception $e) {
			$this->assertTrue(false);
	...
	function test_entry_category_scheme_1 () { 
		$content = file_get_contents('../feedparsertests/wellformed/atom10/entry_category_scheme.xml');
		try {
			$feed = new XML_Feed_Parser($content);
		} catch (XML_Feed_Parser_Exception $e) {
			$this->assertTrue(false);
	...
	function test_entry_category_term_1 () { 
		$content = file_get_contents('../feedparsertests/wellformed/atom10/entry_category_term.xml');
		try {
			$feed = new XML_Feed_Parser($content);
		} catch (XML_Feed_Parser_Exception $e) {
			$this->assertTrue(false);
	...
	function test_entry_content_application_xml_1 () { 
		$content = file_get_contents('../feedparsertests/wellformed/atom10/entry_content_application_xml.xml');
		try {
			$feed = new XML_Feed_Parser($content);
		} catch (XML_Feed_Parser_Exception $e) {
			$this->assertTrue(false);
	...
	function test_entry_content_base64_1 () { 
		$content = file_get_contents('../feedparsertests/wellformed/atom10/entry_content_base64.xml');
		try {
			$feed = new XML_Feed_Parser($content);
		} catch (XML_Feed_Parser_Exception $e) {
			$this->assertTrue(false);
	...
	function test_entry_content_base64_2_1 () { 
		$content = file_get_contents('../feedparsertests/wellformed/atom10/entry_content_base64_2.xml');
		try {
			$feed = new XML_Feed_Parser($content);
		} catch (XML_Feed_Parser_Exception $e) {
			$this->assertTrue(false);
	...
	function test_entry_content_escaped_markup_1 () { 
		$content = file_get_contents('../feedparsertests/wellformed/atom10/entry_content_escaped_markup.xml');
		try {
			$feed = new XML_Feed_Parser($content);
		} catch (XML_Feed_Parser_Exception $e) {
			$this->assertTrue(false);
	...
	function test_entry_content_inline_markup_1 () { 
		$content = file_get_contents('../feedparsertests/wellformed/atom10/entry_content_inline_markup.xml');
		try {
			$feed = new XML_Feed_Parser($content);
		} catch (XML_Feed_Parser_Exception $e) {
			$this->assertTrue(false);
	...
	function test_entry_content_inline_markup_2_1 () { 
		$content = file_get_contents('../feedparsertests/wellformed/atom10/entry_content_inline_markup_2.xml');
		try {
			$feed = new XML_Feed_Parser($content);
		} catch (XML_Feed_Parser_Exception $e) {
			$this->assertTrue(false);
	...
	function test_entry_content_src_1 () { 
		$content = file_get_contents('../feedparsertests/wellformed/atom10/entry_content_src.xml');
		try {
			$feed = new XML_Feed_Parser($content);
		} catch (XML_Feed_Parser_Exception $e) {
			$this->assertTrue(false);
	...
	function test_entry_content_text_plain_1 () { 
		$content = file_get_contents('../feedparsertests/wellformed/atom10/entry_content_text_plain.xml');
		try {
			$feed = new XML_Feed_Parser($content);
		} catch (XML_Feed_Parser_Exception $e) {
			$this->assertTrue(false);
	...
	function test_entry_content_text_plain_brackets_1 () { 
		$content = file_get_contents('../feedparsertests/wellformed/atom10/entry_content_text_plain_brackets.xml');
		try {
			$feed = new XML_Feed_Parser($content);
		} catch (XML_Feed_Parser_Exception $e) {
			$this->assertTrue(false);
	...
	function test_entry_content_type_1 () { 
		$content = file_get_contents('../feedparsertests/wellformed/atom10/entry_content_type.xml');
		try {
			$feed = new XML_Feed_Parser($content);
		} catch (XML_Feed_Parser_Exception $e) {
			$this->assertTrue(false);
	...
	function test_entry_content_type_text_1 () { 
		$content = file_get_contents('../feedparsertests/wellformed/atom10/entry_content_type_text.xml');
		try {
			$feed = new XML_Feed_Parser($content);
		} catch (XML_Feed_Parser_Exception $e) {
			$this->assertTrue(false);
	...
	function test_entry_content_value_1 () { 
		$content = file_get_contents('../feedparsertests/wellformed/atom10/entry_content_value.xml');
		try {
			$feed = new XML_Feed_Parser($content);
		} catch (XML_Feed_Parser_Exception $e) {
			$this->assertTrue(false);
	...
	function test_entry_contributor_email_1 () { 
		$content = file_get_contents('../feedparsertests/wellformed/atom10/entry_contributor_email.xml');
		try {
			$feed = new XML_Feed_Parser($content);
		} catch (XML_Feed_Parser_Exception $e) {
			$this->assertTrue(false);
	...
	function test_entry_contributor_multiple_1 () { 
		$content = file_get_contents('../feedparsertests/wellformed/atom10/entry_contributor_multiple.xml');
		try {
			$feed = new XML_Feed_Parser($content);
		} catch (XML_Feed_Parser_Exception $e) {
			$this->assertTrue(false);
	...
	function test_entry_contributor_name_1 () { 
		$content = file_get_contents('../feedparsertests/wellformed/atom10/entry_contributor_name.xml');
		try {
			$feed = new XML_Feed_Parser($content);
		} catch (XML_Feed_Parser_Exception $e) {
			$this->assertTrue(false);
	...
	function test_entry_contributor_uri_1 () { 
		$content = file_get_contents('../feedparsertests/wellformed/atom10/entry_contributor_uri.xml');
		try {
			$feed = new XML_Feed_Parser($content);
		} catch (XML_Feed_Parser_Exception $e) {
			$this->assertTrue(false);
	...
	function test_entry_contributor_url_1 () { 
		$content = file_get_contents('../feedparsertests/wellformed/atom10/entry_contributor_url.xml');
		try {
			$feed = new XML_Feed_Parser($content);
		} catch (XML_Feed_Parser_Exception $e) {
			$this->assertTrue(false);
	...
	function test_entry_id_1 () { 
		$content = file_get_contents('../feedparsertests/wellformed/atom10/entry_id.xml');
		try {
			$feed = new XML_Feed_Parser($content);
		} catch (XML_Feed_Parser_Exception $e) {
			$this->assertTrue(false);
	...
	function test_entry_id_map_guid_1 () { 
		$content = file_get_contents('../feedparsertests/wellformed/atom10/entry_id_map_guid.xml');
		try {
			$feed = new XML_Feed_Parser($content);
		} catch (XML_Feed_Parser_Exception $e) {
			$this->assertTrue(false);
	...
	function test_entry_id_no_normalization_1_1 () { 
		$content = file_get_contents('../feedparsertests/wellformed/atom10/entry_id_no_normalization_1.xml');
		try {
			$feed = new XML_Feed_Parser($content);
		} catch (XML_Feed_Parser_Exception $e) {
			$this->assertTrue(false);
	...
	function test_entry_id_no_normalization_2_1 () { 
		$content = file_get_contents('../feedparsertests/wellformed/atom10/entry_id_no_normalization_2.xml');
		try {
			$feed = new XML_Feed_Parser($content);
		} catch (XML_Feed_Parser_Exception $e) {
			$this->assertTrue(false);
	...
	function test_entry_id_no_normalization_3_1 () { 
		$content = file_get_contents('../feedparsertests/wellformed/atom10/entry_id_no_normalization_3.xml');
		try {
			$feed = new XML_Feed_Parser($content);
		} catch (XML_Feed_Parser_Exception $e) {
			$this->assertTrue(false);
	...
	function test_entry_id_no_normalization_4_1 () { 
		$content = file_get_contents('../feedparsertests/wellformed/atom10/entry_id_no_normalization_4.xml');
		try {
			$feed = new XML_Feed_Parser($content);
		} catch (XML_Feed_Parser_Exception $e) {
			$this->assertTrue(false);
	...
	function test_entry_id_no_normalization_5_1 () { 
		$content = file_get_contents('../feedparsertests/wellformed/atom10/entry_id_no_normalization_5.xml');
		try {
			$feed = new XML_Feed_Parser($content);
		} catch (XML_Feed_Parser_Exception $e) {
			$this->assertTrue(false);
	...
	function test_entry_id_no_normalization_6_1 () { 
		$content = file_get_contents('../feedparsertests/wellformed/atom10/entry_id_no_normalization_6.xml');
		try {
			$feed = new XML_Feed_Parser($content);
		} catch (XML_Feed_Parser_Exception $e) {
			$this->assertTrue(false);
	...
	function test_entry_id_no_normalization_7_1 () { 
		$content = file_get_contents('../feedparsertests/wellformed/atom10/entry_id_no_normalization_7.xml');
		try {
			$feed = new XML_Feed_Parser($content);
		} catch (XML_Feed_Parser_Exception $e) {
			$this->assertTrue(false);
	...
	function test_entry_link_alternate_map_link_1 () { 
		$content = file_get_contents('../feedparsertests/wellformed/atom10/entry_link_alternate_map_link.xml');
		try {
			$feed = new XML_Feed_Parser($content);
		} catch (XML_Feed_Parser_Exception $e) {
			$this->assertTrue(false);
	...
	function test_entry_link_alternate_map_link_2_1 () { 
		$content = file_get_contents('../feedparsertests/wellformed/atom10/entry_link_alternate_map_link_2.xml');
		try {
			$feed = new XML_Feed_Parser($content);
		} catch (XML_Feed_Parser_Exception $e) {
			$this->assertTrue(false);
	...
	function test_entry_link_alternate_map_link_3_1 () { 
		$content = file_get_contents('../feedparsertests/wellformed/atom10/entry_link_alternate_map_link_3.xml');
		try {
			$feed = new XML_Feed_Parser($content);
		} catch (XML_Feed_Parser_Exception $e) {
			$this->assertTrue(false);
	...
	function test_entry_link_href_1 () { 
		$content = file_get_contents('../feedparsertests/wellformed/atom10/entry_link_href.xml');
		try {
			$feed = new XML_Feed_Parser($content);
		} catch (XML_Feed_Parser_Exception $e) {
			$this->assertTrue(false);
	...
	function test_entry_link_hreflang_1 () { 
		$content = file_get_contents('../feedparsertests/wellformed/atom10/entry_link_hreflang.xml');
		try {
			$feed = new XML_Feed_Parser($content);
		} catch (XML_Feed_Parser_Exception $e) {
			$this->assertTrue(false);
	...
	function test_entry_link_length_1 () { 
		$content = file_get_contents('../feedparsertests/wellformed/atom10/entry_link_length.xml');
		try {
			$feed = new XML_Feed_Parser($content);
		} catch (XML_Feed_Parser_Exception $e) {
			$this->assertTrue(false);
	...
	function test_entry_link_multiple_1 () { 
		$content = file_get_contents('../feedparsertests/wellformed/atom10/entry_link_multiple.xml');
		try {
			$feed = new XML_Feed_Parser($content);
		} catch (XML_Feed_Parser_Exception $e) {
			$this->assertTrue(false);
	...
	function test_entry_link_no_rel_1 () { 
		$content = file_get_contents('../feedparsertests/wellformed/atom10/entry_link_no_rel.xml');
		try {
			$feed = new XML_Feed_Parser($content);
		} catch (XML_Feed_Parser_Exception $e) {
			$this->assertTrue(false);
	...
	function test_entry_link_rel_1 () { 
		$content = file_get_contents('../feedparsertests/wellformed/atom10/entry_link_rel.xml');
		try {
			$feed = new XML_Feed_Parser($content);
		} catch (XML_Feed_Parser_Exception $e) {
			$this->assertTrue(false);
	...
	function test_entry_link_rel_enclosure_1 () { 
		$content = file_get_contents('../feedparsertests/wellformed/atom10/entry_link_rel_enclosure.xml');
		try {
			$feed = new XML_Feed_Parser($content);
		} catch (XML_Feed_Parser_Exception $e) {
			$this->assertTrue(false);
	...
	function test_entry_link_rel_enclosure_map_enclosure_length_1 () { 
		$content = file_get_contents('../feedparsertests/wellformed/atom10/entry_link_rel_enclosure_map_enclosure_length.xml');
		try {
			$feed = new XML_Feed_Parser($content);
		} catch (XML_Feed_Parser_Exception $e) {
			$this->assertTrue(false);
	...
	function test_entry_link_rel_enclosure_map_enclosure_type_1 () { 
		$content = file_get_contents('../feedparsertests/wellformed/atom10/entry_link_rel_enclosure_map_enclosure_type.xml');
		try {
			$feed = new XML_Feed_Parser($content);
		} catch (XML_Feed_Parser_Exception $e) {
			$this->assertTrue(false);
	...
	function test_entry_link_rel_enclosure_map_enclosure_url_1 () { 
		$content = file_get_contents('../feedparsertests/wellformed/atom10/entry_link_rel_enclosure_map_enclosure_url.xml');
		try {
			$feed = new XML_Feed_Parser($content);
		} catch (XML_Feed_Parser_Exception $e) {
			$this->assertTrue(false);
	...
	function test_entry_link_rel_other_1 () { 
		$content = file_get_contents('../feedparsertests/wellformed/atom10/entry_link_rel_other.xml');
		try {
			$feed = new XML_Feed_Parser($content);
		} catch (XML_Feed_Parser_Exception $e) {
			$this->assertTrue(false);
	...
	function test_entry_link_rel_related_1 () { 
		$content = file_get_contents('../feedparsertests/wellformed/atom10/entry_link_rel_related.xml');
		try {
			$feed = new XML_Feed_Parser($content);
		} catch (XML_Feed_Parser_Exception $e) {
			$this->assertTrue(false);
	...
	function test_entry_link_rel_self_1 () { 
		$content = file_get_contents('../feedparsertests/wellformed/atom10/entry_link_rel_self.xml');
		try {
			$feed = new XML_Feed_Parser($content);
		} catch (XML_Feed_Parser_Exception $e) {
			$this->assertTrue(false);
	...
	function test_entry_link_rel_via_1 () { 
		$content = file_get_contents('../feedparsertests/wellformed/atom10/entry_link_rel_via.xml');
		try {
			$feed = new XML_Feed_Parser($content);
		} catch (XML_Feed_Parser_Exception $e) {
			$this->assertTrue(false);
	...
	function test_entry_link_title_1 () { 
		$content = file_get_contents('../feedparsertests/wellformed/atom10/entry_link_title.xml');
		try {
			$feed = new XML_Feed_Parser($content);
		} catch (XML_Feed_Parser_Exception $e) {
			$this->assertTrue(false);
	...
	function test_entry_link_type_1 () { 
		$content = file_get_contents('../feedparsertests/wellformed/atom10/entry_link_type.xml');
		try {
			$feed = new XML_Feed_Parser($content);
		} catch (XML_Feed_Parser_Exception $e) {
			$this->assertTrue(false);
	...
	function test_entry_rights_1 () { 
		$content = file_get_contents('../feedparsertests/wellformed/atom10/entry_rights.xml');
		try {
			$feed = new XML_Feed_Parser($content);
		} catch (XML_Feed_Parser_Exception $e) {
			$this->assertTrue(false);
	...
	function test_entry_rights_content_value_1 () { 
		$content = file_get_contents('../feedparsertests/wellformed/atom10/entry_rights_content_value.xml');
		try {
			$feed = new XML_Feed_Parser($content);
		} catch (XML_Feed_Parser_Exception $e) {
			$this->assertTrue(false);
	...
	function test_entry_rights_escaped_markup_1 () { 
		$content = file_get_contents('../feedparsertests/wellformed/atom10/entry_rights_escaped_markup.xml');
		try {
			$feed = new XML_Feed_Parser($content);
		} catch (XML_Feed_Parser_Exception $e) {
			$this->assertTrue(false);
	...
	function test_entry_rights_inline_markup_1 () { 
		$content = file_get_contents('../feedparsertests/wellformed/atom10/entry_rights_inline_markup.xml');
		try {
			$feed = new XML_Feed_Parser($content);
		} catch (XML_Feed_Parser_Exception $e) {
			$this->assertTrue(false);
	...
	function test_entry_rights_inline_markup_2_1 () { 
		$content = file_get_contents('../feedparsertests/wellformed/atom10/entry_rights_inline_markup_2.xml');
		try {
			$feed = new XML_Feed_Parser($content);
		} catch (XML_Feed_Parser_Exception $e) {
			$this->assertTrue(false);
	...
	function test_entry_rights_text_plain_1 () { 
		$content = file_get_contents('../feedparsertests/wellformed/atom10/entry_rights_text_plain.xml');
		try {
			$feed = new XML_Feed_Parser($content);
		} catch (XML_Feed_Parser_Exception $e) {
			$this->assertTrue(false);
	...
	function test_entry_rights_text_plain_brackets_1 () { 
		$content = file_get_contents('../feedparsertests/wellformed/atom10/entry_rights_text_plain_brackets.xml');
		try {
			$feed = new XML_Feed_Parser($content);
		} catch (XML_Feed_Parser_Exception $e) {
			$this->assertTrue(false);
	...
	function test_entry_rights_type_default_1 () { 
		$content = file_get_contents('../feedparsertests/wellformed/atom10/entry_rights_type_default.xml');
		try {
			$feed = new XML_Feed_Parser($content);
		} catch (XML_Feed_Parser_Exception $e) {
			$this->assertTrue(false);
	...
	function test_entry_rights_type_text_1 () { 
		$content = file_get_contents('../feedparsertests/wellformed/atom10/entry_rights_type_text.xml');
		try {
			$feed = new XML_Feed_Parser($content);
		} catch (XML_Feed_Parser_Exception $e) {
			$this->assertTrue(false);
	...
	function test_entry_source_author_email_1 () { 
		$content = file_get_contents('../feedparsertests/wellformed/atom10/entry_source_author_email.xml');
		try {
			$feed = new XML_Feed_Parser($content);
		} catch (XML_Feed_Parser_Exception $e) {
			$this->assertTrue(false);
	...
	function test_entry_source_author_map_author_1 () { 
		$content = file_get_contents('../feedparsertests/wellformed/atom10/entry_source_author_map_author.xml');
		try {
			$feed = new XML_Feed_Parser($content);
		} catch (XML_Feed_Parser_Exception $e) {
			$this->assertTrue(false);
	...
	function test_entry_source_author_map_author_2_1 () { 
		$content = file_get_contents('../feedparsertests/wellformed/atom10/entry_source_author_map_author_2.xml');
		try {
			$feed = new XML_Feed_Parser($content);
		} catch (XML_Feed_Parser_Exception $e) {
			$this->assertTrue(false);
	...
	function test_entry_source_author_name_1 () { 
		$content = file_get_contents('../feedparsertests/wellformed/atom10/entry_source_author_name.xml');
		try {
			$feed = new XML_Feed_Parser($content);
		} catch (XML_Feed_Parser_Exception $e) {
			$this->assertTrue(false);
	...
	function test_entry_source_author_uri_1 () { 
		$content = file_get_contents('../feedparsertests/wellformed/atom10/entry_source_author_uri.xml');
		try {
			$feed = new XML_Feed_Parser($content);
		} catch (XML_Feed_Parser_Exception $e) {
			$this->assertTrue(false);
	...
	function test_entry_source_category_label_1 () { 
		$content = file_get_contents('../feedparsertests/wellformed/atom10/entry_source_category_label.xml');
		try {
			$feed = new XML_Feed_Parser($content);
		} catch (XML_Feed_Parser_Exception $e) {
			$this->assertTrue(false);
	...
	function test_entry_source_category_scheme_1 () { 
		$content = file_get_contents('../feedparsertests/wellformed/atom10/entry_source_category_scheme.xml');
		try {
			$feed = new XML_Feed_Parser($content);
		} catch (XML_Feed_Parser_Exception $e) {
			$this->assertTrue(false);
	...
	function test_entry_source_category_term_1 () { 
		$content = file_get_contents('../feedparsertests/wellformed/atom10/entry_source_category_term.xml');
		try {
			$feed = new XML_Feed_Parser($content);
		} catch (XML_Feed_Parser_Exception $e) {
			$this->assertTrue(false);
	...
	function test_entry_source_contributor_email_1 () { 
		$content = file_get_contents('../feedparsertests/wellformed/atom10/entry_source_contributor_email.xml');
		try {
			$feed = new XML_Feed_Parser($content);
		} catch (XML_Feed_Parser_Exception $e) {
			$this->assertTrue(false);
	...
	function test_entry_source_contributor_multiple_1 () { 
		$content = file_get_contents('../feedparsertests/wellformed/atom10/entry_source_contributor_multiple.xml');
		try {
			$feed = new XML_Feed_Parser($content);
		} catch (XML_Feed_Parser_Exception $e) {
			$this->assertTrue(false);
	...
	function test_entry_source_contributor_name_1 () { 
		$content = file_get_contents('../feedparsertests/wellformed/atom10/entry_source_contributor_name.xml');
		try {
			$feed = new XML_Feed_Parser($content);
		} catch (XML_Feed_Parser_Exception $e) {
			$this->assertTrue(false);
	...
	function test_entry_source_contributor_uri_1 () { 
		$content = file_get_contents('../feedparsertests/wellformed/atom10/entry_source_contributor_uri.xml');
		try {
			$feed = new XML_Feed_Parser($content);
		} catch (XML_Feed_Parser_Exception $e) {
			$this->assertTrue(false);
	...
	function test_entry_source_generator_1 () { 
		$content = file_get_contents('../feedparsertests/wellformed/atom10/entry_source_generator.xml');
		try {
			$feed = new XML_Feed_Parser($content);
		} catch (XML_Feed_Parser_Exception $e) {
			$this->assertTrue(false);
	...
	function test_entry_source_generator_name_1 () { 
		$content = file_get_contents('../feedparsertests/wellformed/atom10/entry_source_generator_name.xml');
		try {
			$feed = new XML_Feed_Parser($content);
		} catch (XML_Feed_Parser_Exception $e) {
			$this->assertTrue(false);
	...
	function test_entry_source_generator_uri_1 () { 
		$content = file_get_contents('../feedparsertests/wellformed/atom10/entry_source_generator_uri.xml');
		try {
			$feed = new XML_Feed_Parser($content);
		} catch (XML_Feed_Parser_Exception $e) {
			$this->assertTrue(false);
	...
	function test_entry_source_generator_version_1 () { 
		$content = file_get_contents('../feedparsertests/wellformed/atom10/entry_source_generator_version.xml');
		try {
			$feed = new XML_Feed_Parser($content);
		} catch (XML_Feed_Parser_Exception $e) {
			$this->assertTrue(false);
	...
	function test_entry_source_icon_1 () { 
		$content = file_get_contents('../feedparsertests/wellformed/atom10/entry_source_icon.xml');
		try {
			$feed = new XML_Feed_Parser($content);
		} catch (XML_Feed_Parser_Exception $e) {
			$this->assertTrue(false);
	...
	function test_entry_source_id_1 () { 
		$content = file_get_contents('../feedparsertests/wellformed/atom10/entry_source_id.xml');
		try {
			$feed = new XML_Feed_Parser($content);
		} catch (XML_Feed_Parser_Exception $e) {
			$this->assertTrue(false);
	...
	function test_entry_source_link_alternate_map_link_1 () { 
		$content = file_get_contents('../feedparsertests/wellformed/atom10/entry_source_link_alternate_map_link.xml');
		try {
			$feed = new XML_Feed_Parser($content);
		} catch (XML_Feed_Parser_Exception $e) {
			$this->assertTrue(false);
	...
	function test_entry_source_link_alternate_map_link_2_1 () { 
		$content = file_get_contents('../feedparsertests/wellformed/atom10/entry_source_link_alternate_map_link_2.xml');
		try {
			$feed = new XML_Feed_Parser($content);
		} catch (XML_Feed_Parser_Exception $e) {
			$this->assertTrue(false);
	...
	function test_entry_source_link_href_1 () { 
		$content = file_get_contents('../feedparsertests/wellformed/atom10/entry_source_link_href.xml');
		try {
			$feed = new XML_Feed_Parser($content);
		} catch (XML_Feed_Parser_Exception $e) {
			$this->assertTrue(false);
	...
	function test_entry_source_link_hreflang_1 () { 
		$content = file_get_contents('../feedparsertests/wellformed/atom10/entry_source_link_hreflang.xml');
		try {
			$feed = new XML_Feed_Parser($content);
		} catch (XML_Feed_Parser_Exception $e) {
			$this->assertTrue(false);
	...
	function test_entry_source_link_length_1 () { 
		$content = file_get_contents('../feedparsertests/wellformed/atom10/entry_source_link_length.xml');
		try {
			$feed = new XML_Feed_Parser($content);
		} catch (XML_Feed_Parser_Exception $e) {
			$this->assertTrue(false);
	...
	function test_entry_source_link_multiple_1 () { 
		$content = file_get_contents('../feedparsertests/wellformed/atom10/entry_source_link_multiple.xml');
		try {
			$feed = new XML_Feed_Parser($content);
		} catch (XML_Feed_Parser_Exception $e) {
			$this->assertTrue(false);
	...
	function test_entry_source_link_no_rel_1 () { 
		$content = file_get_contents('../feedparsertests/wellformed/atom10/entry_source_link_no_rel.xml');
		try {
			$feed = new XML_Feed_Parser($content);
		} catch (XML_Feed_Parser_Exception $e) {
			$this->assertTrue(false);
	...
	function test_entry_source_link_rel_1 () { 
		$content = file_get_contents('../feedparsertests/wellformed/atom10/entry_source_link_rel.xml');
		try {
			$feed = new XML_Feed_Parser($content);
		} catch (XML_Feed_Parser_Exception $e) {
			$this->assertTrue(false);
	...
	function test_entry_source_link_rel_other_1 () { 
		$content = file_get_contents('../feedparsertests/wellformed/atom10/entry_source_link_rel_other.xml');
		try {
			$feed = new XML_Feed_Parser($content);
		} catch (XML_Feed_Parser_Exception $e) {
			$this->assertTrue(false);
	...
	function test_entry_source_link_rel_related_1 () { 
		$content = file_get_contents('../feedparsertests/wellformed/atom10/entry_source_link_rel_related.xml');
		try {
			$feed = new XML_Feed_Parser($content);
		} catch (XML_Feed_Parser_Exception $e) {
			$this->assertTrue(false);
	...
	function test_entry_source_link_rel_self_1 () { 
		$content = file_get_contents('../feedparsertests/wellformed/atom10/entry_source_link_rel_self.xml');
		try {
			$feed = new XML_Feed_Parser($content);
		} catch (XML_Feed_Parser_Exception $e) {
			$this->assertTrue(false);
	...
	function test_entry_source_link_rel_via_1 () { 
		$content = file_get_contents('../feedparsertests/wellformed/atom10/entry_source_link_rel_via.xml');
		try {
			$feed = new XML_Feed_Parser($content);
		} catch (XML_Feed_Parser_Exception $e) {
			$this->assertTrue(false);
	...
	function test_entry_source_link_title_1 () { 
		$content = file_get_contents('../feedparsertests/wellformed/atom10/entry_source_link_title.xml');
		try {
			$feed = new XML_Feed_Parser($content);
		} catch (XML_Feed_Parser_Exception $e) {
			$this->assertTrue(false);
	...
	function test_entry_source_link_type_1 () { 
		$content = file_get_contents('../feedparsertests/wellformed/atom10/entry_source_link_type.xml');
		try {
			$feed = new XML_Feed_Parser($content);
		} catch (XML_Feed_Parser_Exception $e) {
			$this->assertTrue(false);
	...
	function test_entry_source_logo_1 () { 
		$content = file_get_contents('../feedparsertests/wellformed/atom10/entry_source_logo.xml');
		try {
			$feed = new XML_Feed_Parser($content);
		} catch (XML_Feed_Parser_Exception $e) {
			$this->assertTrue(false);
	...
	function test_entry_source_rights_1 () { 
		$content = file_get_contents('../feedparsertests/wellformed/atom10/entry_source_rights.xml');
		try {
			$feed = new XML_Feed_Parser($content);
		} catch (XML_Feed_Parser_Exception $e) {
			$this->assertTrue(false);
	...
	function test_entry_source_rights_base64_1 () { 
		$content = file_get_contents('../feedparsertests/wellformed/atom10/entry_source_rights_base64.xml');
		try {
			$feed = new XML_Feed_Parser($content);
		} catch (XML_Feed_Parser_Exception $e) {
			$this->assertTrue(false);
	...
	function test_entry_source_rights_base64_2_1 () { 
		$content = file_get_contents('../feedparsertests/wellformed/atom10/entry_source_rights_base64_2.xml');
		try {
			$feed = new XML_Feed_Parser($content);
		} catch (XML_Feed_Parser_Exception $e) {
			$this->assertTrue(false);
	...
	function test_entry_source_rights_content_type_1 () { 
		$content = file_get_contents('../feedparsertests/wellformed/atom10/entry_source_rights_content_type.xml');
		try {
			$feed = new XML_Feed_Parser($content);
		} catch (XML_Feed_Parser_Exception $e) {
			$this->assertTrue(false);
	...
	function test_entry_source_rights_content_type_text_1 () { 
		$content = file_get_contents('../feedparsertests/wellformed/atom10/entry_source_rights_content_type_text.xml');
		try {
			$feed = new XML_Feed_Parser($content);
		} catch (XML_Feed_Parser_Exception $e) {
			$this->assertTrue(false);
	...
	function test_entry_source_rights_content_value_1 () { 
		$content = file_get_contents('../feedparsertests/wellformed/atom10/entry_source_rights_content_value.xml');
		try {
			$feed = new XML_Feed_Parser($content);
		} catch (XML_Feed_Parser_Exception $e) {
			$this->assertTrue(false);
	...
	function test_entry_source_rights_escaped_markup_1 () { 
		$content = file_get_contents('../feedparsertests/wellformed/atom10/entry_source_rights_escaped_markup.xml');
		try {
			$feed = new XML_Feed_Parser($content);
		} catch (XML_Feed_Parser_Exception $e) {
			$this->assertTrue(false);
	...
	function test_entry_source_rights_inline_markup_1 () { 
		$content = file_get_contents('../feedparsertests/wellformed/atom10/entry_source_rights_inline_markup.xml');
		try {
			$feed = new XML_Feed_Parser($content);
		} catch (XML_Feed_Parser_Exception $e) {
			$this->assertTrue(false);
	...
	function test_entry_source_rights_inline_markup_2_1 () { 
		$content = file_get_contents('../feedparsertests/wellformed/atom10/entry_source_rights_inline_markup_2.xml');
		try {
			$feed = new XML_Feed_Parser($content);
		} catch (XML_Feed_Parser_Exception $e) {
			$this->assertTrue(false);
	...
	function test_entry_source_rights_text_plain_1 () { 
		$content = file_get_contents('../feedparsertests/wellformed/atom10/entry_source_rights_text_plain.xml');
		try {
			$feed = new XML_Feed_Parser($content);
		} catch (XML_Feed_Parser_Exception $e) {
			$this->assertTrue(false);
	...
	function test_entry_source_subittle_content_type_text_1 () { 
		$content = file_get_contents('../feedparsertests/wellformed/atom10/entry_source_subittle_content_type_text.xml');
		try {
			$feed = new XML_Feed_Parser($content);
		} catch (XML_Feed_Parser_Exception $e) {
			$this->assertTrue(false);
	...
	function test_entry_source_subtitle_1 () { 
		$content = file_get_contents('../feedparsertests/wellformed/atom10/entry_source_subtitle.xml');
		try {
			$feed = new XML_Feed_Parser($content);
		} catch (XML_Feed_Parser_Exception $e) {
			$this->assertTrue(false);
	...
	function test_entry_source_subtitle_base64_1 () { 
		$content = file_get_contents('../feedparsertests/wellformed/atom10/entry_source_subtitle_base64.xml');
		try {
			$feed = new XML_Feed_Parser($content);
		} catch (XML_Feed_Parser_Exception $e) {
			$this->assertTrue(false);
	...
	function test_entry_source_subtitle_base64_2_1 () { 
		$content = file_get_contents('../feedparsertests/wellformed/atom10/entry_source_subtitle_base64_2.xml');
		try {
			$feed = new XML_Feed_Parser($content);
		} catch (XML_Feed_Parser_Exception $e) {
			$this->assertTrue(false);
	...
	function test_entry_source_subtitle_content_type_1 () { 
		$content = file_get_contents('../feedparsertests/wellformed/atom10/entry_source_subtitle_content_type.xml');
		try {
			$feed = new XML_Feed_Parser($content);
		} catch (XML_Feed_Parser_Exception $e) {
			$this->assertTrue(false);
	...
	function test_entry_source_subtitle_content_value_1 () { 
		$content = file_get_contents('../feedparsertests/wellformed/atom10/entry_source_subtitle_content_value.xml');
		try {
			$feed = new XML_Feed_Parser($content);
		} catch (XML_Feed_Parser_Exception $e) {
			$this->assertTrue(false);
	...
	function test_entry_source_subtitle_escaped_markup_1 () { 
		$content = file_get_contents('../feedparsertests/wellformed/atom10/entry_source_subtitle_escaped_markup.xml');
		try {
			$feed = new XML_Feed_Parser($content);
		} catch (XML_Feed_Parser_Exception $e) {
			$this->assertTrue(false);
	...
	function test_entry_source_subtitle_inline_markup_1 () { 
		$content = file_get_contents('../feedparsertests/wellformed/atom10/entry_source_subtitle_inline_markup.xml');
		try {
			$feed = new XML_Feed_Parser($content);
		} catch (XML_Feed_Parser_Exception $e) {
			$this->assertTrue(false);
	...
	function test_entry_source_subtitle_inline_markup_2_1 () { 
		$content = file_get_contents('../feedparsertests/wellformed/atom10/entry_source_subtitle_inline_markup_2.xml');
		try {
			$feed = new XML_Feed_Parser($content);
		} catch (XML_Feed_Parser_Exception $e) {
			$this->assertTrue(false);
	...
	function test_entry_source_subtitle_text_plain_1 () { 
		$content = file_get_contents('../feedparsertests/wellformed/atom10/entry_source_subtitle_text_plain.xml');
		try {
			$feed = new XML_Feed_Parser($content);
		} catch (XML_Feed_Parser_Exception $e) {
			$this->assertTrue(false);
	...
	function test_entry_source_title_1 () { 
		$content = file_get_contents('../feedparsertests/wellformed/atom10/entry_source_title.xml');
		try {
			$feed = new XML_Feed_Parser($content);
		} catch (XML_Feed_Parser_Exception $e) {
			$this->assertTrue(false);
	...
	function test_entry_source_title_base64_1 () { 
		$content = file_get_contents('../feedparsertests/wellformed/atom10/entry_source_title_base64.xml');
		try {
			$feed = new XML_Feed_Parser($content);
		} catch (XML_Feed_Parser_Exception $e) {
			$this->assertTrue(false);
	...
	function test_entry_source_title_base64_2_1 () { 
		$content = file_get_contents('../feedparsertests/wellformed/atom10/entry_source_title_base64_2.xml');
		try {
			$feed = new XML_Feed_Parser($content);
		} catch (XML_Feed_Parser_Exception $e) {
			$this->assertTrue(false);
	...
	function test_entry_source_title_content_type_1 () { 
		$content = file_get_contents('../feedparsertests/wellformed/atom10/entry_source_title_content_type.xml');
		try {
			$feed = new XML_Feed_Parser($content);
		} catch (XML_Feed_Parser_Exception $e) {
			$this->assertTrue(false);
	...
	function test_entry_source_title_content_type_text_1 () { 
		$content = file_get_contents('../feedparsertests/wellformed/atom10/entry_source_title_content_type_text.xml');
		try {
			$feed = new XML_Feed_Parser($content);
		} catch (XML_Feed_Parser_Exception $e) {
			$this->assertTrue(false);
	...
	function test_entry_source_title_content_value_1 () { 
		$content = file_get_contents('../feedparsertests/wellformed/atom10/entry_source_title_content_value.xml');
		try {
			$feed = new XML_Feed_Parser($content);
		} catch (XML_Feed_Parser_Exception $e) {
			$this->assertTrue(false);
	...
	function test_entry_source_title_escaped_markup_1 () { 
		$content = file_get_contents('../feedparsertests/wellformed/atom10/entry_source_title_escaped_markup.xml');
		try {
			$feed = new XML_Feed_Parser($content);
		} catch (XML_Feed_Parser_Exception $e) {
			$this->assertTrue(false);
	...
	function test_entry_source_title_inline_markup_1 () { 
		$content = file_get_contents('../feedparsertests/wellformed/atom10/entry_source_title_inline_markup.xml');
		try {
			$feed = new XML_Feed_Parser($content);
		} catch (XML_Feed_Parser_Exception $e) {
			$this->assertTrue(false);
	...
	function test_entry_source_title_inline_markup_2_1 () { 
		$content = file_get_contents('../feedparsertests/wellformed/atom10/entry_source_title_inline_markup_2.xml');
		try {
			$feed = new XML_Feed_Parser($content);
		} catch (XML_Feed_Parser_Exception $e) {
			$this->assertTrue(false);
	...
	function test_entry_source_title_text_plain_1 () { 
		$content = file_get_contents('../feedparsertests/wellformed/atom10/entry_source_title_text_plain.xml');
		try {
			$feed = new XML_Feed_Parser($content);
		} catch (XML_Feed_Parser_Exception $e) {
			$this->assertTrue(false);
	...
	function test_entry_summary_1 () { 
		$content = file_get_contents('../feedparsertests/wellformed/atom10/entry_summary.xml');
		try {
			$feed = new XML_Feed_Parser($content);
		} catch (XML_Feed_Parser_Exception $e) {
			$this->assertTrue(false);
	...
	function test_entry_summary_base64_1 () { 
		$content = file_get_contents('../feedparsertests/wellformed/atom10/entry_summary_base64.xml');
		try {
			$feed = new XML_Feed_Parser($content);
		} catch (XML_Feed_Parser_Exception $e) {
			$this->assertTrue(false);
	...
	function test_entry_summary_base64_2_1 () { 
		$content = file_get_contents('../feedparsertests/wellformed/atom10/entry_summary_base64_2.xml');
		try {
			$feed = new XML_Feed_Parser($content);
		} catch (XML_Feed_Parser_Exception $e) {
			$this->assertTrue(false);
	...
	function test_entry_summary_content_value_1 () { 
		$content = file_get_contents('../feedparsertests/wellformed/atom10/entry_summary_content_value.xml');
		try {
			$feed = new XML_Feed_Parser($content);
		} catch (XML_Feed_Parser_Exception $e) {
			$this->assertTrue(false);
	...
	function test_entry_summary_escaped_markup_1 () { 
		$content = file_get_contents('../feedparsertests/wellformed/atom10/entry_summary_escaped_markup.xml');
		try {
			$feed = new XML_Feed_Parser($content);
		} catch (XML_Feed_Parser_Exception $e) {
			$this->assertTrue(false);
	...
	function test_entry_summary_inline_markup_1 () { 
		$content = file_get_contents('../feedparsertests/wellformed/atom10/entry_summary_inline_markup.xml');
		try {
			$feed = new XML_Feed_Parser($content);
		} catch (XML_Feed_Parser_Exception $e) {
			$this->assertTrue(false);
	...
	function test_entry_summary_inline_markup_2_1 () { 
		$content = file_get_contents('../feedparsertests/wellformed/atom10/entry_summary_inline_markup_2.xml');
		try {
			$feed = new XML_Feed_Parser($content);
		} catch (XML_Feed_Parser_Exception $e) {
			$this->assertTrue(false);
	...
	function test_entry_summary_text_plain_1 () { 
		$content = file_get_contents('../feedparsertests/wellformed/atom10/entry_summary_text_plain.xml');
		try {
			$feed = new XML_Feed_Parser($content);
		} catch (XML_Feed_Parser_Exception $e) {
			$this->assertTrue(false);
	...
	function test_entry_summary_type_default_1 () { 
		$content = file_get_contents('../feedparsertests/wellformed/atom10/entry_summary_type_default.xml');
		try {
			$feed = new XML_Feed_Parser($content);
		} catch (XML_Feed_Parser_Exception $e) {
			$this->assertTrue(false);
	...
	function test_entry_summary_type_text_1 () { 
		$content = file_get_contents('../feedparsertests/wellformed/atom10/entry_summary_type_text.xml');
		try {
			$feed = new XML_Feed_Parser($content);
		} catch (XML_Feed_Parser_Exception $e) {
			$this->assertTrue(false);
	...
	function test_entry_title_1 () { 
		$content = file_get_contents('../feedparsertests/wellformed/atom10/entry_title.xml');
		try {
			$feed = new XML_Feed_Parser($content);
		} catch (XML_Feed_Parser_Exception $e) {
			$this->assertTrue(false);
	...
	function test_entry_title_base64_1 () { 
		$content = file_get_contents('../feedparsertests/wellformed/atom10/entry_title_base64.xml');
		try {
			$feed = new XML_Feed_Parser($content);
		} catch (XML_Feed_Parser_Exception $e) {
			$this->assertTrue(false);
	...
	function test_entry_title_base64_2_1 () { 
		$content = file_get_contents('../feedparsertests/wellformed/atom10/entry_title_base64_2.xml');
		try {
			$feed = new XML_Feed_Parser($content);
		} catch (XML_Feed_Parser_Exception $e) {
			$this->assertTrue(false);
	...
	function test_entry_title_content_value_1 () { 
		$content = file_get_contents('../feedparsertests/wellformed/atom10/entry_title_content_value.xml');
		try {
			$feed = new XML_Feed_Parser($content);
		} catch (XML_Feed_Parser_Exception $e) {
			$this->assertTrue(false);
	...
	function test_entry_title_escaped_markup_1 () { 
		$content = file_get_contents('../feedparsertests/wellformed/atom10/entry_title_escaped_markup.xml');
		try {
			$feed = new XML_Feed_Parser($content);
		} catch (XML_Feed_Parser_Exception $e) {
			$this->assertTrue(false);
	...
	function test_entry_title_inline_markup_1 () { 
		$content = file_get_contents('../feedparsertests/wellformed/atom10/entry_title_inline_markup.xml');
		try {
			$feed = new XML_Feed_Parser($content);
		} catch (XML_Feed_Parser_Exception $e) {
			$this->assertTrue(false);
	...
	function test_entry_title_inline_markup_2_1 () { 
		$content = file_get_contents('../feedparsertests/wellformed/atom10/entry_title_inline_markup_2.xml');
		try {
			$feed = new XML_Feed_Parser($content);
		} catch (XML_Feed_Parser_Exception $e) {
			$this->assertTrue(false);
	...
	function test_entry_title_text_plain_1 () { 
		$content = file_get_contents('../feedparsertests/wellformed/atom10/entry_title_text_plain.xml');
		try {
			$feed = new XML_Feed_Parser($content);
		} catch (XML_Feed_Parser_Exception $e) {
			$this->assertTrue(false);
	...
	function test_entry_title_text_plain_brackets_1 () { 
		$content = file_get_contents('../feedparsertests/wellformed/atom10/entry_title_text_plain_brackets.xml');
		try {
			$feed = new XML_Feed_Parser($content);
		} catch (XML_Feed_Parser_Exception $e) {
			$this->assertTrue(false);
	...
	function test_entry_title_type_default_1 () { 
		$content = file_get_contents('../feedparsertests/wellformed/atom10/entry_title_type_default.xml');
		try {
			$feed = new XML_Feed_Parser($content);
		} catch (XML_Feed_Parser_Exception $e) {
			$this->assertTrue(false);
	...
	function test_entry_title_type_text_1 () { 
		$content = file_get_contents('../feedparsertests/wellformed/atom10/entry_title_type_text.xml');
		try {
			$feed = new XML_Feed_Parser($content);
		} catch (XML_Feed_Parser_Exception $e) {
			$this->assertTrue(false);
	...
	function test_feed_author_email_1 () { 
		$content = file_get_contents('../feedparsertests/wellformed/atom10/feed_author_email.xml');
		try {
			$feed = new XML_Feed_Parser($content);
		} catch (XML_Feed_Parser_Exception $e) {
			$this->assertTrue(false);
	...
	function test_feed_author_map_author_1 () { 
		$content = file_get_contents('../feedparsertests/wellformed/atom10/feed_author_map_author.xml');
		try {
			$feed = new XML_Feed_Parser($content);
		} catch (XML_Feed_Parser_Exception $e) {
			$this->assertTrue(false);
	...
	function test_feed_author_map_author_2_1 () { 
		$content = file_get_contents('../feedparsertests/wellformed/atom10/feed_author_map_author_2.xml');
		try {
			$feed = new XML_Feed_Parser($content);
		} catch (XML_Feed_Parser_Exception $e) {
			$this->assertTrue(false);
	...
	function test_feed_author_name_1 () { 
		$content = file_get_contents('../feedparsertests/wellformed/atom10/feed_author_name.xml');
		try {
			$feed = new XML_Feed_Parser($content);
		} catch (XML_Feed_Parser_Exception $e) {
			$this->assertTrue(false);
	...
	function test_feed_author_uri_1 () { 
		$content = file_get_contents('../feedparsertests/wellformed/atom10/feed_author_uri.xml');
		try {
			$feed = new XML_Feed_Parser($content);
		} catch (XML_Feed_Parser_Exception $e) {
			$this->assertTrue(false);
	...
	function test_feed_author_url_1 () { 
		$content = file_get_contents('../feedparsertests/wellformed/atom10/feed_author_url.xml');
		try {
			$feed = new XML_Feed_Parser($content);
		} catch (XML_Feed_Parser_Exception $e) {
			$this->assertTrue(false);
	...
	function test_feed_contributor_email_1 () { 
		$content = file_get_contents('../feedparsertests/wellformed/atom10/feed_contributor_email.xml');
		try {
			$feed = new XML_Feed_Parser($content);
		} catch (XML_Feed_Parser_Exception $e) {
			$this->assertTrue(false);
	...
	function test_feed_contributor_multiple_1 () { 
		$content = file_get_contents('../feedparsertests/wellformed/atom10/feed_contributor_multiple.xml');
		try {
			$feed = new XML_Feed_Parser($content);
		} catch (XML_Feed_Parser_Exception $e) {
			$this->assertTrue(false);
	...
	function test_feed_contributor_name_1 () { 
		$content = file_get_contents('../feedparsertests/wellformed/atom10/feed_contributor_name.xml');
		try {
			$feed = new XML_Feed_Parser($content);
		} catch (XML_Feed_Parser_Exception $e) {
			$this->assertTrue(false);
	...
	function test_feed_contributor_uri_1 () { 
		$content = file_get_contents('../feedparsertests/wellformed/atom10/feed_contributor_uri.xml');
		try {
			$feed = new XML_Feed_Parser($content);
		} catch (XML_Feed_Parser_Exception $e) {
			$this->assertTrue(false);
	...
	function test_feed_contributor_url_1 () { 
		$content = file_get_contents('../feedparsertests/wellformed/atom10/feed_contributor_url.xml');
		try {
			$feed = new XML_Feed_Parser($content);
		} catch (XML_Feed_Parser_Exception $e) {
			$this->assertTrue(false);
	...
	function test_feed_generator_1 () { 
		$content = file_get_contents('../feedparsertests/wellformed/atom10/feed_generator.xml');
		try {
			$feed = new XML_Feed_Parser($content);
		} catch (XML_Feed_Parser_Exception $e) {
			$this->assertTrue(false);
	...
	function test_feed_generator_name_1 () { 
		$content = file_get_contents('../feedparsertests/wellformed/atom10/feed_generator_name.xml');
		try {
			$feed = new XML_Feed_Parser($content);
		} catch (XML_Feed_Parser_Exception $e) {
			$this->assertTrue(false);
	...
	function test_feed_generator_url_1 () { 
		$content = file_get_contents('../feedparsertests/wellformed/atom10/feed_generator_url.xml');
		try {
			$feed = new XML_Feed_Parser($content);
		} catch (XML_Feed_Parser_Exception $e) {
			$this->assertTrue(false);
	...
	function test_feed_generator_version_1 () { 
		$content = file_get_contents('../feedparsertests/wellformed/atom10/feed_generator_version.xml');
		try {
			$feed = new XML_Feed_Parser($content);
		} catch (XML_Feed_Parser_Exception $e) {
			$this->assertTrue(false);
	...
	function test_feed_icon_1 () { 
		$content = file_get_contents('../feedparsertests/wellformed/atom10/feed_icon.xml');
		try {
			$feed = new XML_Feed_Parser($content);
		} catch (XML_Feed_Parser_Exception $e) {
			$this->assertTrue(false);
	...
	function test_feed_id_1 () { 
		$content = file_get_contents('../feedparsertests/wellformed/atom10/feed_id.xml');
		try {
			$feed = new XML_Feed_Parser($content);
		} catch (XML_Feed_Parser_Exception $e) {
			$this->assertTrue(false);
	...
	function test_feed_id_map_guid_1 () { 
		$content = file_get_contents('../feedparsertests/wellformed/atom10/feed_id_map_guid.xml');
		try {
			$feed = new XML_Feed_Parser($content);
		} catch (XML_Feed_Parser_Exception $e) {
			$this->assertTrue(false);
	...
	function test_feed_link_alternate_map_link_1 () { 
		$content = file_get_contents('../feedparsertests/wellformed/atom10/feed_link_alternate_map_link.xml');
		try {
			$feed = new XML_Feed_Parser($content);
		} catch (XML_Feed_Parser_Exception $e) {
			$this->assertTrue(false);
	...
	function test_feed_link_alternate_map_link_2_1 () { 
		$content = file_get_contents('../feedparsertests/wellformed/atom10/feed_link_alternate_map_link_2.xml');
		try {
			$feed = new XML_Feed_Parser($content);
		} catch (XML_Feed_Parser_Exception $e) {
			$this->assertTrue(false);
	...
	function test_feed_link_href_1 () { 
		$content = file_get_contents('../feedparsertests/wellformed/atom10/feed_link_href.xml');
		try {
			$feed = new XML_Feed_Parser($content);
		} catch (XML_Feed_Parser_Exception $e) {
			$this->assertTrue(false);
	...
	function test_feed_link_hreflang_1 () { 
		$content = file_get_contents('../feedparsertests/wellformed/atom10/feed_link_hreflang.xml');
		try {
			$feed = new XML_Feed_Parser($content);
		} catch (XML_Feed_Parser_Exception $e) {
			$this->assertTrue(false);
	...
	function test_feed_link_length_1 () { 
		$content = file_get_contents('../feedparsertests/wellformed/atom10/feed_link_length.xml');
		try {
			$feed = new XML_Feed_Parser($content);
		} catch (XML_Feed_Parser_Exception $e) {
			$this->assertTrue(false);
	...
	function test_feed_link_multiple_1 () { 
		$content = file_get_contents('../feedparsertests/wellformed/atom10/feed_link_multiple.xml');
		try {
			$feed = new XML_Feed_Parser($content);
		} catch (XML_Feed_Parser_Exception $e) {
			$this->assertTrue(false);
	...
	function test_feed_link_no_rel_1 () { 
		$content = file_get_contents('../feedparsertests/wellformed/atom10/feed_link_no_rel.xml');
		try {
			$feed = new XML_Feed_Parser($content);
		} catch (XML_Feed_Parser_Exception $e) {
			$this->assertTrue(false);
	...
	function test_feed_link_rel_1 () { 
		$content = file_get_contents('../feedparsertests/wellformed/atom10/feed_link_rel.xml');
		try {
			$feed = new XML_Feed_Parser($content);
		} catch (XML_Feed_Parser_Exception $e) {
			$this->assertTrue(false);
	...
	function test_feed_link_rel_other_1 () { 
		$content = file_get_contents('../feedparsertests/wellformed/atom10/feed_link_rel_other.xml');
		try {
			$feed = new XML_Feed_Parser($content);
		} catch (XML_Feed_Parser_Exception $e) {
			$this->assertTrue(false);
	...
	function test_feed_link_rel_related_1 () { 
		$content = file_get_contents('../feedparsertests/wellformed/atom10/feed_link_rel_related.xml');
		try {
			$feed = new XML_Feed_Parser($content);
		} catch (XML_Feed_Parser_Exception $e) {
			$this->assertTrue(false);
	...
	function test_feed_link_rel_self_1 () { 
		$content = file_get_contents('../feedparsertests/wellformed/atom10/feed_link_rel_self.xml');
		try {
			$feed = new XML_Feed_Parser($content);
		} catch (XML_Feed_Parser_Exception $e) {
			$this->assertTrue(false);
	...
	function test_feed_link_rel_via_1 () { 
		$content = file_get_contents('../feedparsertests/wellformed/atom10/feed_link_rel_via.xml');
		try {
			$feed = new XML_Feed_Parser($content);
		} catch (XML_Feed_Parser_Exception $e) {
			$this->assertTrue(false);
	...
	function test_feed_link_title_1 () { 
		$content = file_get_contents('../feedparsertests/wellformed/atom10/feed_link_title.xml');
		try {
			$feed = new XML_Feed_Parser($content);
		} catch (XML_Feed_Parser_Exception $e) {
			$this->assertTrue(false);
	...
	function test_feed_link_type_1 () { 
		$content = file_get_contents('../feedparsertests/wellformed/atom10/feed_link_type.xml');
		try {
			$feed = new XML_Feed_Parser($content);
		} catch (XML_Feed_Parser_Exception $e) {
			$this->assertTrue(false);
	...
	function test_feed_logo_1 () { 
		$content = file_get_contents('../feedparsertests/wellformed/atom10/feed_logo.xml');
		try {
			$feed = new XML_Feed_Parser($content);
		} catch (XML_Feed_Parser_Exception $e) {
			$this->assertTrue(false);
	...
	function test_feed_rights_1 () { 
		$content = file_get_contents('../feedparsertests/wellformed/atom10/feed_rights.xml');
		try {
			$feed = new XML_Feed_Parser($content);
		} catch (XML_Feed_Parser_Exception $e) {
			$this->assertTrue(false);
	...
	function test_feed_rights_base64_1 () { 
		$content = file_get_contents('../feedparsertests/wellformed/atom10/feed_rights_base64.xml');
		try {
			$feed = new XML_Feed_Parser($content);
		} catch (XML_Feed_Parser_Exception $e) {
			$this->assertTrue(false);
	...
	function test_feed_rights_base64_2_1 () { 
		$content = file_get_contents('../feedparsertests/wellformed/atom10/feed_rights_base64_2.xml');
		try {
			$feed = new XML_Feed_Parser($content);
		} catch (XML_Feed_Parser_Exception $e) {
			$this->assertTrue(false);
	...
	function test_feed_rights_content_type_1 () { 
		$content = file_get_contents('../feedparsertests/wellformed/atom10/feed_rights_content_type.xml');
		try {
			$feed = new XML_Feed_Parser($content);
		} catch (XML_Feed_Parser_Exception $e) {
			$this->assertTrue(false);
	...
	function test_feed_rights_content_type_text_1 () { 
		$content = file_get_contents('../feedparsertests/wellformed/atom10/feed_rights_content_type_text.xml');
		try {
			$feed = new XML_Feed_Parser($content);
		} catch (XML_Feed_Parser_Exception $e) {
			$this->assertTrue(false);
	...
	function test_feed_rights_content_value_1 () { 
		$content = file_get_contents('../feedparsertests/wellformed/atom10/feed_rights_content_value.xml');
		try {
			$feed = new XML_Feed_Parser($content);
		} catch (XML_Feed_Parser_Exception $e) {
			$this->assertTrue(false);
	...
	function test_feed_rights_escaped_markup_1 () { 
		$content = file_get_contents('../feedparsertests/wellformed/atom10/feed_rights_escaped_markup.xml');
		try {
			$feed = new XML_Feed_Parser($content);
		} catch (XML_Feed_Parser_Exception $e) {
			$this->assertTrue(false);
	...
	function test_feed_rights_inline_markup_1 () { 
		$content = file_get_contents('../feedparsertests/wellformed/atom10/feed_rights_inline_markup.xml');
		try {
			$feed = new XML_Feed_Parser($content);
		} catch (XML_Feed_Parser_Exception $e) {
			$this->assertTrue(false);
	...
	function test_feed_rights_inline_markup_2_1 () { 
		$content = file_get_contents('../feedparsertests/wellformed/atom10/feed_rights_inline_markup_2.xml');
		try {
			$feed = new XML_Feed_Parser($content);
		} catch (XML_Feed_Parser_Exception $e) {
			$this->assertTrue(false);
	...
	function test_feed_rights_text_plain_1 () { 
		$content = file_get_contents('../feedparsertests/wellformed/atom10/feed_rights_text_plain.xml');
		try {
			$feed = new XML_Feed_Parser($content);
		} catch (XML_Feed_Parser_Exception $e) {
			$this->assertTrue(false);
	...
	function test_feed_subtitle_1 () { 
		$content = file_get_contents('../feedparsertests/wellformed/atom10/feed_subtitle.xml');
		try {
			$feed = new XML_Feed_Parser($content);
		} catch (XML_Feed_Parser_Exception $e) {
			$this->assertTrue(false);
	...
	function test_feed_subtitle_base64_1 () { 
		$content = file_get_contents('../feedparsertests/wellformed/atom10/feed_subtitle_base64.xml');
		try {
			$feed = new XML_Feed_Parser($content);
		} catch (XML_Feed_Parser_Exception $e) {
			$this->assertTrue(false);
	...
	function test_feed_subtitle_base64_2_1 () { 
		$content = file_get_contents('../feedparsertests/wellformed/atom10/feed_subtitle_base64_2.xml');
		try {
			$feed = new XML_Feed_Parser($content);
		} catch (XML_Feed_Parser_Exception $e) {
			$this->assertTrue(false);
	...
	function test_feed_subtitle_content_type_1 () { 
		$content = file_get_contents('../feedparsertests/wellformed/atom10/feed_subtitle_content_type.xml');
		try {
			$feed = new XML_Feed_Parser($content);
		} catch (XML_Feed_Parser_Exception $e) {
			$this->assertTrue(false);
	...
	function test_feed_subtitle_content_type_text_1 () { 
		$content = file_get_contents('../feedparsertests/wellformed/atom10/feed_subtitle_content_type_text.xml');
		try {
			$feed = new XML_Feed_Parser($content);
		} catch (XML_Feed_Parser_Exception $e) {
			$this->assertTrue(false);
	...
	function test_feed_subtitle_content_value_1 () { 
		$content = file_get_contents('../feedparsertests/wellformed/atom10/feed_subtitle_content_value.xml');
		try {
			$feed = new XML_Feed_Parser($content);
		} catch (XML_Feed_Parser_Exception $e) {
			$this->assertTrue(false);
	...
	function test_feed_subtitle_escaped_markup_1 () { 
		$content = file_get_contents('../feedparsertests/wellformed/atom10/feed_subtitle_escaped_markup.xml');
		try {
			$feed = new XML_Feed_Parser($content);
		} catch (XML_Feed_Parser_Exception $e) {
			$this->assertTrue(false);
	...
	function test_feed_subtitle_inline_markup_1 () { 
		$content = file_get_contents('../feedparsertests/wellformed/atom10/feed_subtitle_inline_markup.xml');
		try {
			$feed = new XML_Feed_Parser($content);
		} catch (XML_Feed_Parser_Exception $e) {
			$this->assertTrue(false);
	...
	function test_feed_subtitle_inline_markup_2_1 () { 
		$content = file_get_contents('../feedparsertests/wellformed/atom10/feed_subtitle_inline_markup_2.xml');
		try {
			$feed = new XML_Feed_Parser($content);
		} catch (XML_Feed_Parser_Exception $e) {
			$this->assertTrue(false);
	...
	function test_feed_subtitle_text_plain_1 () { 
		$content = file_get_contents('../feedparsertests/wellformed/atom10/feed_subtitle_text_plain.xml');
		try {
			$feed = new XML_Feed_Parser($content);
		} catch (XML_Feed_Parser_Exception $e) {
			$this->assertTrue(false);
	...
	function test_feed_title_1 () { 
		$content = file_get_contents('../feedparsertests/wellformed/atom10/feed_title.xml');
		try {
			$feed = new XML_Feed_Parser($content);
		} catch (XML_Feed_Parser_Exception $e) {
			$this->assertTrue(false);
	...
	function test_feed_title_base64_1 () { 
		$content = file_get_contents('../feedparsertests/wellformed/atom10/feed_title_base64.xml');
		try {
			$feed = new XML_Feed_Parser($content);
		} catch (XML_Feed_Parser_Exception $e) {
			$this->assertTrue(false);
	...
	function test_feed_title_base64_2_1 () { 
		$content = file_get_contents('../feedparsertests/wellformed/atom10/feed_title_base64_2.xml');
		try {
			$feed = new XML_Feed_Parser($content);
		} catch (XML_Feed_Parser_Exception $e) {
			$this->assertTrue(false);
	...
	function test_feed_title_content_type_1 () { 
		$content = file_get_contents('../feedparsertests/wellformed/atom10/feed_title_content_type.xml');
		try {
			$feed = new XML_Feed_Parser($content);
		} catch (XML_Feed_Parser_Exception $e) {
			$this->assertTrue(false);
	...
	function test_feed_title_content_type_text_1 () { 
		$content = file_get_contents('../feedparsertests/wellformed/atom10/feed_title_content_type_text.xml');
		try {
			$feed = new XML_Feed_Parser($content);
		} catch (XML_Feed_Parser_Exception $e) {
			$this->assertTrue(false);
	...
	function test_feed_title_content_value_1 () { 
		$content = file_get_contents('../feedparsertests/wellformed/atom10/feed_title_content_value.xml');
		try {
			$feed = new XML_Feed_Parser($content);
		} catch (XML_Feed_Parser_Exception $e) {
			$this->assertTrue(false);
	...
	function test_feed_title_escaped_markup_1 () { 
		$content = file_get_contents('../feedparsertests/wellformed/atom10/feed_title_escaped_markup.xml');
		try {
			$feed = new XML_Feed_Parser($content);
		} catch (XML_Feed_Parser_Exception $e) {
			$this->assertTrue(false);
	...
	function test_feed_title_inline_markup_1 () { 
		$content = file_get_contents('../feedparsertests/wellformed/atom10/feed_title_inline_markup.xml');
		try {
			$feed = new XML_Feed_Parser($content);
		} catch (XML_Feed_Parser_Exception $e) {
			$this->assertTrue(false);
	...
	function test_feed_title_inline_markup_2_1 () { 
		$content = file_get_contents('../feedparsertests/wellformed/atom10/feed_title_inline_markup_2.xml');
		try {
			$feed = new XML_Feed_Parser($content);
		} catch (XML_Feed_Parser_Exception $e) {
			$this->assertTrue(false);
	...
	function test_feed_title_text_plain_1 () { 
		$content = file_get_contents('../feedparsertests/wellformed/atom10/feed_title_text_plain.xml');
		try {
			$feed = new XML_Feed_Parser($content);
		} catch (XML_Feed_Parser_Exception $e) {
			$this->assertTrue(false);
	...
	function test_relative_uri_1 () { 
		$content = file_get_contents('../feedparsertests/wellformed/atom10/relative_uri.xml');
		try {
			$feed = new XML_Feed_Parser($content);
		} catch (XML_Feed_Parser_Exception $e) {
			$this->assertTrue(false);
	...
	function test_relative_uri_inherit_1 () { 
		$content = file_get_contents('../feedparsertests/wellformed/atom10/relative_uri_inherit.xml');
		try {
			$feed = new XML_Feed_Parser($content);
		} catch (XML_Feed_Parser_Exception $e) {
			$this->assertTrue(false);
	...
	function test_relative_uri_inherit_2_1 () { 
		$content = file_get_contents('../feedparsertests/wellformed/atom10/relative_uri_inherit_2.xml');
		try {
			$feed = new XML_Feed_Parser($content);
		} catch (XML_Feed_Parser_Exception $e) {
			$this->assertTrue(false);
